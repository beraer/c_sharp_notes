...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GroupB.Models.Concert", b =>
                {
            ...
            modelBuilder.Entity("GroupB.Models.Customer", b =>
                {
            ...
            modelBuilder.Entity("GroupB.Models.PurchasedTicket", b =>
                {
            ...
            modelBuilder.Entity("GroupB.Models.Ticket", b =>
                {
            ...
            modelBuilder.Entity("GroupB.Models.TicketConcert", b =>
                {
                    b.Property<int>("TicketConcertId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GroupB.Models.PurchasedTicket", b =>
                {
                    b.HasOne("GroupB.Models.Customer", "Customer")
                        .WithMany("PurchasedTickets")
                        .HasForeignKey("CustomerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("GroupB.Models.TicketConcert", "TicketConcert")
            ...
            modelBuilder.Entity("GroupB.Models.TicketConcert", b =>
                {
                    b.HasOne("GroupB.Models.Concert", "Concert")
                        .WithMany("TicketConcerts")
                        .HasForeignKey("ConcertId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("GroupB.Models.Ticket", "Ticket")
                        .WithMany("TicketConcerts")
